...
def make_actor(say):
    ...
    actor.add_keyword(_('custom actions'), SpeakAction(say, """The custom actions are: radio, play, news headlines, currency check, reboot and shutdown. To hear this list again, say, custom actions"""))
